...
module.exports = {
    name: 'guild',
    description: 'Get the info of the guild',
    example: "```kb guild RAWR```",
    execute(message, args) {
        ...
        let getMembers = (uuid) => {
            ...
            .then(res => {
                ...
                let guildMessage = new Discord.MessageEmbed()
                    .setTitle(`${res.data.name} | Guild Information`)
                    .setColor("PURPLE")
                    .addFields(
                        {
                            name: "**General Info**", 
                    ...
                    .setThumbnail('https://hypixel.net/data/guild_banners/100x200/' + res.data.id + ".png")
